---
title: "FishMIP Model Evaluation Protocol: ISIMIP3a"
---
...
In the output files, please label the time variable as months since January 1st, 1840.
...
-   The relative time axis' reference year and month to include in model output is months since January 1^st^ 1841.
